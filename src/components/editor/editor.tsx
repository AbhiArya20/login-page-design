                  ...
                  toast.custom(
                    (toast) => (
                      <ToastContent
                        toast={toast}
                        title="Hey there!"
                        message="Thanks for your interest, but toolbar is disabled right now."
                      />
                    ),
                    {
                      id: toastId,
                  ...
                  toast.custom(
                    (toast) => (
                      <ToastContent
                        toast={toast}
                        title="Hey there!"
                        message="Thanks for your interest, but difference view is disabled right now."
                      />
                    ),
                    {
                      id: toastId,
...
const TabItem = ({
  ...
  <div
    className={`flex gap-2 text-zinc-600 font-semibold  ${
      isSelected && "border-t border-t-blue-700"
            ...
            toast.custom(
              (toast) => (
                <ToastContent
                  toast={toast}
                  title="Hey there!"
                  message="Thanks for your interest, but this tab can't be closed right now."
                />
              ),
              {
                id: toastId,
